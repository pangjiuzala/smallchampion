...
public class Loading_Link extends Activity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			finish();
			com.nuc.smallchampion.util.Assist.transActivity(Loading_Link.this,
					MainActivity.class);
			return true;
		}
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			startActivity(new Intent(Loading_Link.this, Link.class));
			finish();
		}
	};
