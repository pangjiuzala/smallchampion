...
public class PuzzleGame10 extends Activity {
	...
	int setDraw[] = new int[] { R.drawable.map115_01, R.drawable.map115_02,
			R.drawable.map115_03, R.drawable.map115_04, R.drawable.map115_05,
			R.drawable.map115_06, R.drawable.map115_07, R.drawable.map115_08,
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				PuzzleGame10.this.startActivity(Intent.createChooser(intent, "分享"));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_puzzlegame10);
		Toast.makeText(PuzzleGame10.this, "点击图片打乱顺序",
				Toast.LENGTH_SHORT).show();



		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(PuzzleGame10.this, R.raw.click, 1);
		click1 = soundPool.load(PuzzleGame10.this, R.raw.success, 1);
		click2 = soundPool.load(PuzzleGame10.this, R.raw.click6, 1);
		click3 = soundPool.load(PuzzleGame10.this, R.raw.click1, 1);
				...
				.setNegativeButton("换一个",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								com.nuc.smallchampion.util.Assist.transActivity(
										PuzzleGame10.this, PuzzleGame_Choose.class);
							}
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
												int whichButton) {
								com.nuc.smallchampion.util.Assist.transActivity(
										PuzzleGame10.this, MainActivity.class);
								finish();

							}

						});
		first= (Button) this.findViewById(R.id.first10);
		...
		pause = (Button) this.findViewById(R.id.bace10);
		pause.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View source) {
				com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame10.this, PuzzleGame10.class);
			}
		});
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame10.this,
					...
					switch (flag) {
						case 0:
							...
							if (currentLocation[1] == 8) {
								...
								Toast.makeText(PuzzleGame10.this, "坚持就是胜利",
										Toast.LENGTH_SHORT).show();
								play = true;
							}
							break;
	...
	public void isEnd() {
		...
		puzzle[8].setBackgroundResource(R.drawable.map115_09);
		mplayer.stop();
