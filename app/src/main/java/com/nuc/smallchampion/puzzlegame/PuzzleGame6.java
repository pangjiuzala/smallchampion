...
public class PuzzleGame6 extends Activity {
	...
	int setDraw[] = new int[] { R.drawable.map111_01, R.drawable.map111_02,
			R.drawable.map111_03, R.drawable.map111_04, R.drawable.map111_05,
			R.drawable.map111_06, R.drawable.map111_07, R.drawable.map111_08,
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				PuzzleGame6.this.startActivity(Intent.createChooser(intent, "分享"));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_puzzlegame6);
		Toast.makeText(PuzzleGame6.this, "点击图片打乱顺序",
				Toast.LENGTH_SHORT).show();


		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(PuzzleGame6.this, R.raw.click, 1);
		click1 = soundPool.load(PuzzleGame6.this, R.raw.success, 1);
		click2 = soundPool.load(PuzzleGame6.this, R.raw.click6, 1);
		click3= soundPool.load(PuzzleGame6.this, R.raw.click1, 1);
				...
				.setNegativeButton("换一个",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								com.nuc.smallchampion.util.Assist.transActivity(
										PuzzleGame6.this, PuzzleGame_Choose.class);
							}
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
												int whichButton) {
								com.nuc.smallchampion.util.Assist.transActivity(
										PuzzleGame6.this, MainActivity.class);
								finish();

							}

						});
		first= (Button) this.findViewById(R.id.first6);
		...
		pause = (Button) this.findViewById(R.id.bace6);
		pause.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View source) {
				com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame6.this, PuzzleGame6.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame6.this,
		...
		for (int i = 0; i < 9; i++) {
			...
			puzzle[flag].setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					switch (flag) {
						case 0:	soundPool.play(click2, 1, 1, 0, 0, 1);
							if (currentLocation[1] == 8) {
								...
								Toast.makeText(PuzzleGame6.this, "坚持就是胜利",
										Toast.LENGTH_SHORT).show();
								play = true;
							}
							break;
						case 1:	soundPool.play(click2, 1, 1, 0, 0, 1);
							...
							break;
						case 2:	soundPool.play(click2, 1, 1, 0, 0, 1);
							if (currentLocation[1] == 8) {
								swapImage(flag, 1);
								play = true;
							...
							break;
						case 3:	soundPool.play(click2, 1, 1, 0, 0, 1);
							if (currentLocation[0] == 8) {
								swapImage(flag, 0);
								play = true;
							...
							break;
						case 4:	soundPool.play(click2, 1, 1, 0, 0, 1);
							if (currentLocation[1] == 8) {
								swapImage(flag, 1);
								play = true;
							...
							break;
						case 5:	soundPool.play(click2, 1, 1, 0, 0, 1);
							...
							break;
						case 6:	soundPool.play(click2, 1, 1, 0, 0, 1);
							...
							break;
						case 7:	soundPool.play(click2, 1, 1, 0, 0, 1);
							...
							break;
						case 8:	soundPool.play(click2, 1, 1, 0, 0, 1);
	...
	public void isEnd() {
		...
		puzzle[8].setBackgroundResource(R.drawable.map111_09);
