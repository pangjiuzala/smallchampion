...
public class PuzzleGame extends Activity {
	...
	int setDraw[] = new int[] { R.drawable.map105_01, R.drawable.map105_02,
			R.drawable.map105_03, R.drawable.map105_04, R.drawable.map105_05,
			R.drawable.map105_06, R.drawable.map105_07, R.drawable.map105_08,
		...
		new Thread(new Runnable() {
			public void run() {
				...
				intent.putExtra(Intent.EXTRA_TEXT,
						"������Ϸ������С״Ԫ���е�֮��ƴ��������ƪ���ܺ���Ŷ����360�ֻ����֡��㶹�Ի��ƶ�mm�г��������ر�Ӧ�ã�");
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Toast.makeText(PuzzleGame.this, "���ͼƬ����˳��", Toast.LENGTH_SHORT).show();

		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(PuzzleGame.this, R.raw.click, 1);
		click1 = soundPool.load(PuzzleGame.this, R.raw.success, 1);
		click2 = soundPool.load(PuzzleGame.this, R.raw.click6, 1);
		click3 = soundPool.load(PuzzleGame.this, R.raw.click1, 1);

		successDialog = createDialog("�ð���", "����������", R.drawable.success2)
				.setNegativeButton("��һ��",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
												int which) {
								Assist
										.transActivity(PuzzleGame.this,
		...
		pause = (Button) this.findViewById(R.id.bace);
		pause.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View source) {
				Assist.transActivity(
						PuzzleGame.this, PuzzleGame.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			finish();
			Assist.transActivity(PuzzleGame.this,
					PuzzleGame_Choose.class);
			return true;
		}
					...
					switch (flag) {
						case 0:
							...
							if (currentLocation[1] == 8) {
								...
								Toast.makeText(PuzzleGame.this, "��־���ʤ��",
	...
	public void isEnd() {
		...
		puzzle[8].setBackgroundResource(R.drawable.map105_09);
