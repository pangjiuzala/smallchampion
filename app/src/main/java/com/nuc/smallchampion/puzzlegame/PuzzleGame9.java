...
public class PuzzleGame9 extends Activity {
	...
	int setDraw[] = new int[] { R.drawable.map114_01, R.drawable.map114_02,
			R.drawable.map114_03, R.drawable.map114_04, R.drawable.map114_05,
			R.drawable.map114_06, R.drawable.map114_07, R.drawable.map114_08,
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				PuzzleGame9.this.startActivity(Intent.createChooser(intent, "分享"));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_puzzlegame9);
		Toast.makeText(PuzzleGame9.this, "点击图片打乱顺序", Toast.LENGTH_SHORT).show();

		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(PuzzleGame9.this, R.raw.click, 1);
		click1 = soundPool.load(PuzzleGame9.this, R.raw.success, 1);
		click2 = soundPool.load(PuzzleGame9.this, R.raw.click6, 1);
		click3 = soundPool.load(PuzzleGame9.this, R.raw.click1, 1);
				...
				.setNegativeButton("换一个",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								com.nuc.smallchampion.util.Assist.transActivity(
										PuzzleGame9.this, PuzzleGame_Choose.class);
							}
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
												int whichButton) {
								com.nuc.smallchampion.util.Assist.transActivity(
										PuzzleGame9.this, MainActivity.class);
								finish();

							}

						});
		first = (Button) this.findViewById(R.id.first9);
		...
		pause = (Button) this.findViewById(R.id.bace9);
		pause.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View source) {
				com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame9.this,
						PuzzleGame9.class);
					...
					switch (flag) {
						case 0:	soundPool.play(click2, 1, 1, 0, 0, 1);
							if (currentLocation[1] == 8) {
								...
								Toast.makeText(PuzzleGame9.this, "坚持就是胜利",
	...
	public void isEnd() {
		...
		puzzle[8].setBackgroundResource(R.drawable.map114_09);
