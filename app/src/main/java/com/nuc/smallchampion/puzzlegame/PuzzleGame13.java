...
public class PuzzleGame13 extends Activity {
	...
	int setDraw[] = new int[] { R.drawable.map118_01, R.drawable.map118_02,
			R.drawable.map118_03, R.drawable.map118_04, R.drawable.map118_05,
			R.drawable.map118_06, R.drawable.map118_07, R.drawable.map118_08,
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				PuzzleGame13.this.startActivity(Intent.createChooser(intent,
						"分享"));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_puzzlegame13);
		Toast.makeText(PuzzleGame13.this, "点击图片打乱顺序", Toast.LENGTH_SHORT)
				.show();

		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(PuzzleGame13.this, R.raw.click, 1);
		click1 = soundPool.load(PuzzleGame13.this, R.raw.success, 1);
		click2 = soundPool.load(PuzzleGame13.this, R.raw.click6, 1);
		click3 = soundPool.load(PuzzleGame13.this, R.raw.click1, 1);
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								com.nuc.smallchampion.util.Assist
										.transActivity(PuzzleGame13.this,
		...
		first = (Button) this.findViewById(R.id.first13);
		...
		pause = (Button) this.findViewById(R.id.bace13);
		pause.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View source) {
				com.nuc.smallchampion.util.Assist.transActivity(
						PuzzleGame13.this, PuzzleGame13.class);
			}
		});
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame13.this,
					PuzzleGame_Choose.class);
			return true;
		}
					...
					switch (flag) {
						case 0:
							...
							if (currentLocation[1] == 8) {
								...
								Toast.makeText(PuzzleGame13.this, "坚持就是胜利",
	...
	public void isEnd() {
		...
		puzzle[8].setBackgroundResource(R.drawable.map118_09);
