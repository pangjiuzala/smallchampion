...
public class PuzzleGame14 extends Activity {
	...
	int setDraw[] = new int[] { R.drawable.map119_01, R.drawable.map119_02,
			R.drawable.map119_03, R.drawable.map119_04, R.drawable.map119_05,
			R.drawable.map119_06, R.drawable.map119_07, R.drawable.map119_08,
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				PuzzleGame14.this.startActivity(Intent.createChooser(intent,
						"分享"));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_puzzlegame14);
		Toast.makeText(PuzzleGame14.this, "点击图片打乱顺序", Toast.LENGTH_SHORT)
				.show();

		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(PuzzleGame14.this, R.raw.click, 1);
		click1 = soundPool.load(PuzzleGame14.this, R.raw.success, 1);
		click2 = soundPool.load(PuzzleGame14.this, R.raw.click6, 1);
		click3 = soundPool.load(PuzzleGame14.this, R.raw.click1, 1);
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								com.nuc.smallchampion.util.Assist
										.transActivity(PuzzleGame14.this,
		...
		first = (Button) this.findViewById(R.id.first14);
		...
		pause = (Button) this.findViewById(R.id.bace14);
		pause.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View source) {
				com.nuc.smallchampion.util.Assist.transActivity(
						PuzzleGame14.this, PuzzleGame14.class);
			}
		});
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame14.this,
					PuzzleGame_Choose.class);
			return true;
		}
					...
					switch (flag) {
						case 0:
							...
							if (currentLocation[1] == 8) {
								...
								Toast.makeText(PuzzleGame14.this, "坚持就是胜利",
	...
	public void isEnd() {
		...
		puzzle[8].setBackgroundResource(R.drawable.map119_09);
