...
public class PuzzleGame2 extends Activity {
	...
	int setDraw[] = new int[] { R.drawable.map107_01, R.drawable.map107_02,
			R.drawable.map107_03, R.drawable.map107_04, R.drawable.map107_05,
			R.drawable.map107_06, R.drawable.map107_07, R.drawable.map107_08,
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				PuzzleGame2.this.startActivity(Intent.createChooser(intent,
						"分享"));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_puzzlegame2);
		Toast.makeText(PuzzleGame2.this, "点击图片打乱顺序", Toast.LENGTH_SHORT).show();

		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(PuzzleGame2.this, R.raw.click, 1);
		click1 = soundPool.load(PuzzleGame2.this, R.raw.success, 1);
		click2 = soundPool.load(PuzzleGame2.this, R.raw.click6, 1);
		click3= soundPool.load(PuzzleGame2.this, R.raw.click1, 1);
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								com.nuc.smallchampion.util.Assist
										.transActivity(PuzzleGame2.this,
		...
		first = (Button) this.findViewById(R.id.first2);
		...
		pause = (Button) this.findViewById(R.id.bace2);
		pause.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View source) {
				com.nuc.smallchampion.util.Assist.transActivity(
						PuzzleGame2.this, PuzzleGame2.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame2.this,
					PuzzleGame_Choose.class);
			return true;
		}
					...
					switch (flag) {
						case 0:
							...
							if (currentLocation[1] == 8) {
								...
								Toast.makeText(PuzzleGame2.this, "坚持就是胜利",
	...
	public void isEnd() {
		...
		puzzle[8].setBackgroundResource(R.drawable.map107_09);
