...
public class PuzzleGame12 extends Activity {
	...
	int setDraw[] = new int[] { R.drawable.map117_01, R.drawable.map117_02,
			R.drawable.map117_03, R.drawable.map117_04, R.drawable.map117_05,
			R.drawable.map117_06, R.drawable.map117_07, R.drawable.map117_08,
		...
		new Thread(new Runnable() {
			public void run() {
				...
				intent.putExtra(Intent.EXTRA_TEXT,
						"这是游戏“我是小状元”中的之“拼搏人生”篇，很好玩哦！上百度手机助手或豌豆荚即可下载本应用！");
				intent.putExtra(Intent.EXTRA_STREAM,
						Uri.fromFile(new File(Constant.path + time + ".png")));
				intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				PuzzleGame12.this.startActivity(Intent.createChooser(intent, "分享"));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_puzzlegame12);
		Toast.makeText(PuzzleGame12.this, "点击图片打乱顺序",
				Toast.LENGTH_SHORT).show();

		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(PuzzleGame12.this, R.raw.click, 1);
		click1 = soundPool.load(PuzzleGame12.this, R.raw.success, 1);
		click2 = soundPool.load(PuzzleGame12.this, R.raw.click6, 1);
		click3 = soundPool.load(PuzzleGame12.this, R.raw.click1, 1);
				...
				.setNegativeButton("换一个",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								com.nuc.smallchampion.util.Assist.transActivity(
										PuzzleGame12.this, PuzzleGame_Choose.class);
							}
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
												int whichButton) {
								com.nuc.smallchampion.util.Assist.transActivity(
										PuzzleGame12.this, MainActivity.class);
								finish();

							}

						});
		first= (Button) this.findViewById(R.id.first12);
		...
		pause = (Button) this.findViewById(R.id.bace12);
		pause.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View source) {
				com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame12.this, PuzzleGame12.class);
			}
		});
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			finish();
			com.nuc.smallchampion.util.Assist.transActivity(PuzzleGame12.this,
					...
					switch (flag) {
						case 0:
							...
							if (currentLocation[1] == 8) {
								...
								Toast.makeText(PuzzleGame12.this, "坚持就是胜利",
										Toast.LENGTH_SHORT).show();
								play = true;
							}
							break;
	...
	public void isEnd() {
		...
		puzzle[8].setBackgroundResource(R.drawable.map117_09);
