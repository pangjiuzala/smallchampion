...
public class AddGesture2 extends Activity {
	EditText editText;
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				AddGesture2.this.startActivity(Intent.createChooser(intent, "分享"));
			}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			finish();
			com.nuc.smallchampion.util.Assist.transActivity(AddGesture2.this,
					MainActivity.class);
			return true;
		}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		click = soundPool.load(AddGesture2.this, R.raw.music, 1);
		click1 = soundPool.load(AddGesture2.this, R.raw.success, 1);
		...
		gestureView.addOnGesturePerformedListener(new OnGesturePerformedListener() {
			...
			public void onGesturePerformed(GestureOverlayView overlay,
				...
				if (result.size() > 0) {
					...
					new AlertDialog.Builder(AddGesture2.this)
					...
					Toast.makeText(AddGesture2.this, "请认真书写！",  Toast.LENGTH_SHORT)
							.show();
				}
			}
		});
