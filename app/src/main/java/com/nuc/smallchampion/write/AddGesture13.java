...
public class AddGesture13 extends Activity {
	EditText editText;
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				AddGesture13.this.startActivity(Intent.createChooser(intent, "分享"));
			}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			finish();
			com.nuc.smallchampion.util.Assist.transActivity(AddGesture13.this,
					MainActivity.class);
			return true;
		}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_add13);
		// 获取文本编辑框

		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(AddGesture13.this, R.raw.music, 1);
		click1 = soundPool.load(AddGesture13.this, R.raw.success, 1);
		...
		gestureView.addOnGesturePerformedListener(new OnGesturePerformedListener() {
			...
			public void onGesturePerformed(GestureOverlayView overlay,
				...
				if (result.size() > 0) {
					...
					new AlertDialog.Builder(AddGesture13.this)
					...
					Toast.makeText(AddGesture13.this, "请认真书写！", Toast.LENGTH_SHORT)
							.show();
				}
			}
		});
