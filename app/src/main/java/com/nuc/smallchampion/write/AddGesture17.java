...
public class AddGesture17 extends Activity {
	EditText editText;
	...
	public void shareScreenshot() {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				AddGesture17.this.startActivity(Intent.createChooser(intent, "分享"));
			}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			finish();
			com.nuc.smallchampion.util.Assist.transActivity(AddGesture17.this,
					MainActivity.class);
			return true;
		}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_add17);
		// 获取文本编辑框

		soundPool = new SoundPool(3, AudioManager.STREAM_MUSIC, 0);
		click = soundPool.load(AddGesture17.this, R.raw.music, 1);
		click1 = soundPool.load(AddGesture17.this, R.raw.success, 1);
		...
		gestureView.addOnGesturePerformedListener(new OnGesturePerformedListener() {
			...
			public void onGesturePerformed(GestureOverlayView overlay,
				...
				if (result.size() > 0) {
					...
					new AlertDialog.Builder(AddGesture17.this)
					...
					Toast.makeText(AddGesture17.this, "请认真书写！",  Toast.LENGTH_SHORT)
							.show();
				}
			}
		});
