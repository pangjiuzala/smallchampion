...
public class AddGesture1 extends Activity {
	EditText editText;
		...
		new Thread(new Runnable() {
			public void run() {
				...
				intent.putExtra(Intent.EXTRA_TEXT,
						"这是游戏“我是小状元”之“挥斥方遒”篇，练习书法So easy！上百度手机助手或豌豆荚即可下载本应用！");
				intent.putExtra(Intent.EXTRA_STREAM,
						Uri.fromFile(new File(Constant.path + time + ".png")));
				intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				AddGesture1.this.startActivity(Intent.createChooser(intent, "分享"));
			}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			finish();
			com.nuc.smallchampion.util.Assist.transActivity(AddGesture1.this,
					MainActivity.class);
			return true;
		}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		click = soundPool.load(AddGesture1.this, R.raw.music, 1);
		click1 = soundPool.load(AddGesture1.this, R.raw.success, 1);
		...
		gestureView.addOnGesturePerformedListener(new OnGesturePerformedListener() {
			...
			public void onGesturePerformed(GestureOverlayView overlay,
				...
				if (result.size() > 0) {
					...
					new AlertDialog.Builder(AddGesture1.this)
					...
					Toast.makeText(AddGesture1.this, "请认真书写！",  Toast.LENGTH_SHORT)
							.show();
				}
			}
		});
