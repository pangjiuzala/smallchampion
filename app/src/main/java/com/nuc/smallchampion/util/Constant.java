...
public class Constant {
	...
	public static String path = "/sdcard/Rival/";public static final float appVersion = 0.6f;	// 当前游戏版本号，每发布一个新的版本出去都要改这个值
	...
	public static final String path1 = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "Vi" + File.separator + "ScreenShot" + File.separator + "FireControl";
